...
/*
 * Provide the studio productisation contribution operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the studio productisation snapshot operation used by this module and its client
 * applications.
 */
