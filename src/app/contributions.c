...
static const UmiUiPaneSnapshot STUDIO_PANES[] = {
    ...
    { UMI_STUDIO_PANE_AI_MODEL_COMPARISON, "Model Comparison", "studio.ai-model-comparison", "view-grid-symbolic", UMI_UI_PLACEMENT_RIGHT, 158, 0, 1, 1, { 680, 560 } },
...
static const UmiUiActionSnapshot STUDIO_ACTIONS[] = {
    ...
    { "studio.action.pane.ai-model-comparison", UMI_STUDIO_COMMAND_PANE_TOGGLE, "Model Comparison", "Compare answers returned by selected local and remote models", "view-grid-symbolic", "", 1, 1, 1, 1, 609, UMI_STUDIO_PANE_AI_MODEL_COMPARISON, UMI_UI_ACTION_ARGUMENT_NONE },
...
static const UmiUiContributionSnapshot STUDIO_CONTRIBUTIONS[] = {
    ...
    { "studio.contribution.ai-model-comparison", "org.umicom.studio.shell", "umicom.ui.panes", UMI_STUDIO_PANE_AI_MODEL_COMPARISON, 158, 1 },
